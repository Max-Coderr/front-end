...
export default function BookItem({
    ...
    return <div
        ...
        className="w-[676px] h-[217px] bg-[#1A1D1F] mt-[24px] flex p-[20px] gap-[20px] rounded-[8px] border-[#1F272A] border-[1px] hover:border-[#F97316] cursor-pointer">
        <>
            <div
            ...
            <img src={image} alt='image' className="w-[132px] h-[180px] object-cover rounded-[4px]"/>
        </>
        <div className="flex flex-col">
            <div className="flex flex-col gap-2 w-[441px] h-[107px]">
                ...
                <div className="w-[369px] h-[24px] flex gap-4">
                    ...
                    <div className="h-[20px] w-[1px] bg-[white]"></div>
                    <div className="flex gap-1">
                        <img src="/author.svg" alt="author icon" className="w-[22px] h-[18px]"/>
            ...
            <div className="flex justify-between h-[40px] mt-[7px]">
                <button
                    className="bg-[#FFFFFF1A] w-[198px] h-[40px] rounded-[8px] mt-[24px] p-[10px] flex gap-[10px] items-center justify-center font-medium text-[16px] hover:bg-[#F97316] transition-transform duration-300 hover:scale-102">
                    <img src="/HeaderImage/icon3.svg" alt="savatcha" className=""/>Savatchaga
                </button>
                <img src="/likes.svg" alt="likes" className="w-[19.4px] h-[18px] mt-[30px] ml-[280px]"/>
            </div>
        </div>
    </div>
}
